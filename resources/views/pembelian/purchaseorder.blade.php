...
<div class="card">
            <div class="card-body">
              <h5 class="card-title">Form Purchase Order</h5>
              ...
              <form>
                ...
                <div class="row mb-3">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Tipe PO</label>
                    <div class="col-sm-2">
                    <select id="inputState" class="form-select">
                        <option selected>Dengan PP</option>
                        <option value="1">Tanpa PP</option>
                    </select>
                    </div>
                    <label for="inputEmail3" class="col-sm-2 col-form-label text-end" >ID PP</label>
                    <div class="col-sm-3">
                    <select id="inputState" class="form-select">
                        <option selected>PP001</option>
                        <option value="1">PP002</option>
                    </select>
                    </div>
                </div>
          ...
          <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <table class="table datatable">
                        ...
                        <tr>
                            <th scope="col">#</th>
                            <th scope="col">ID Purchase Order</th>
                            <th scope="col">Tipe PO</th>
